...
Machine learning, Bayesian inference, optimization, signal processing, and their applications. Stochastic models and its application to communications. Click \href{https://firsthandscientist.github.io/#/research}{R\&D} to see more about my recent project information.
% ----------------------------------------------------------------------------------------
%	PUBLICATIONS
% ----------------------------------------------------------------------------------------
